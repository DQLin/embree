                        ...
                        const int numTilesY)
{
  ...
  for (unsigned int y=y0; y<y1; y++) for (unsigned int x=x0; x<x1; x++)
  {
    ...
    unsigned int r = (unsigned int) (255.0f * clamp(pow(accu_color.x*f, 1.f/2.2f),0.0f,1.0f));
    unsigned int g = (unsigned int) (255.0f * clamp(pow(accu_color.y*f, 1.f/2.2f),0.0f,1.0f));
    unsigned int b = (unsigned int) (255.0f * clamp(pow(accu_color.z*f, 1.f/2.2f),0.0f,1.0f));
